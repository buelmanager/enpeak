...
import SentenceFlashcardQuiz from './SentenceFlashcardQuiz'
import GapFillQuiz from './GapFillQuiz'
import TranslationQuiz from './TranslationQuiz'

interface SentenceQuizOverlayProps {
  sentences: SavedSentence[]
  mode: 'flashcard' | 'gap-fill' | 'translation'
  onClose: () => void
  onComplete: (results: { id: string; quality: number }[]) => void
}

export default function SentenceQuizOverlay({
  sentences,
  mode,
  onClose,
  onComplete,
}: SentenceQuizOverlayProps) {
  ...
  const handleResult = useCallback(
    (quality: number) => {
      const newResults = [...results, { id: currentSentence.id, quality }]
    ...
    [currentIndex, currentSentence, results, total]
  )
