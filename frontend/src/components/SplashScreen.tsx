...
export default function SplashScreen({ onComplete, minDuration = 1000 }: SplashScreenProps) {
  ...
  return (
    ...
    >
      {/* 로고/앱 아이콘 */}
      <div className="w-20 h-20 rounded-2xl bg-[#0D9488] flex items-center justify-center mb-6 shadow-lg">
      ...
      {/* 앱 이름 */}
      <h1 className="text-2xl font-light text-[#1a1a1a] tracking-wide">
        En<span className="font-medium">Peak</span>
      </h1>
